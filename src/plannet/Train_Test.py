...
from Data_loader import GMPNDataset, GMPNDataset_S2D_RB, GMPNDataset_S2D_TL, GMPNDataset_S2D_ThreeL, GMPNDataset_Arm, \
    GMPNDataset_C3D_Point,GMPNDataset_S2D_Pt
...
def Train_loop_mdn_Joint_train(Enet, Pnet, optimizer, train_dataset, cloud_data, batch_size, device):
    ...
    for x_cur_pos, x_goal_pos, y, index in train_pbar:
        # prepare cloud data
        l = index.shape[0]
        index_l = list(np.array(index, dtype=int).reshape(l))
        x_cloud = torch.from_numpy(cloud_data[index_l, :, :])
        ...
        train_loss += loss.data
        loss.backward()
        # total_norm = torch.nn.utils.clip_grad_norm_(parameters=Enet.parameters(), max_norm=0.05, norm_type=2)
        optimizer.step()
        optimizer.zero_grad()
    return train_loss
...
def Train_Eval_Cloud_input_S2D_ThreeL_MDN_main():
    ...
    train_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Three_Link_train.npy"
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Three_Link_test.npy"
    model_name = "MDN_S2D_ThreeL_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
    ...
    # load or create model and optimizer (checkpoint)
    model = GMPN_S2D_CLOUD_MDN_Pnet(input_size=38, output_size=5, mixture_num=mixture_num)
    model = model.float()
    if device == 'cuda':
        model.cuda()
    else:
...
def Train_Eval_Cloud_input_C3D_Point_MDN_main():
    # parm set
    device = 'cuda'
    ...
    train_data_load_file = "../../data/train/c3d/C3D_Point_Path_new/C3D_Point_Path_new_train.npy"
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/c3d/C3D_Point_Path_new/C3D_Point_Path_new_test.npy"
    model_name = "MDN_C3D_Point_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
    ...
    # load dataset
    print("Start load dataset!")
    train_dataset = GMPNDataset_C3D_Point(data_file=train_data_load_file, env_info_length=env_info_length,
                                          data_len=None)
    # train_env_test_dataset = GMPNDataset(data_file=train_env_test_data_load_file, env_info_length=env_info_length,
    #                                      data_len=None)
    new_env_test_dataset = GMPNDataset_C3D_Point(data_file=new_env_test_data_load_file,
                                                 env_info_length=env_info_length,
                                                 data_len=None)
...
def Train_Eval_Cloud_input_S2D_Pt_MDN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    ...
    train_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Point_Joint_train.npy"
    cloud_file = "../../data/train/s2d/obs_cloud_30000_2_1400_rd.npy"
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Point_Joint_test.npy"
    model_name = "MDN_S2D_Pt_Joint_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
...
def Train_Eval_Cloud_input_S2D_RB_MDN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    ...
    train_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Rigidbody_Joint_train.npy"
    cloud_file = "../../data/train/s2d/obs_cloud_30000_2_1400_rd.npy"
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Rigidbody_Joint_test.npy"
    model_name = "MDN_S2D_RB_Joint_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
    ...
    # load dataset
    print("Start load dataset!")
    train_dataset = GMPNDataset_S2D_RB(data_file=train_data_load_file, env_info_length=env_info_length,
                                       data_len=None, use_env=False)
    # train_env_test_dataset = GMPNDataset(data_file=train_env_test_data_load_file, env_info_length=env_info_length,
    #                                      data_len=None)
    new_env_test_dataset = GMPNDataset_S2D_RB(data_file=new_env_test_data_load_file,
                                              env_info_length=env_info_length,
                                              data_len=None, use_env=False)
    ...
    # load or create model and optimizer (checkpoint)
    Enet = PtNet(dim=2)
    Pnet = GMPN_S2D_CLOUD_MDN_Pnet(input_size=34, output_size=3, mixture_num=mixture_num)
    Enet = Enet.float()
    Pnet = Pnet.float()
    if device == 'cuda':
        Enet.cuda()
...
def Train_Eval_Cloud_input_S2D_TwoL_MDN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    ...
    train_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Two_Link_vec_Joint_train.npy"
    cloud_file = "../../data/train/s2d/obs_cloud_30000_2_1400_rd.npy"
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Two_Link_vec_Joint_test.npy"
    model_name = "MDN_S2D_TwoL_vec_Joint_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
    ...
    train_env_test_batch_size = 256
    new_env_test_batch_size = 356
    env_info_length = 0
    train_data_vis_cnt = 30
    train_env_test_data_vis_cnt = 30
    new_env_test_data_vis_cnt = 30
    ...
    # load dataset
    print("Start load dataset!")
    train_dataset = GMPNDataset_S2D_TL(data_file=train_data_load_file, env_info_length=env_info_length,
                                       data_len=None, use_env=False)
    # train_env_test_dataset = GMPNDataset(data_file=train_env_test_data_load_file, env_info_length=env_info_length,
    #                                      data_len=None)
    new_env_test_dataset = GMPNDataset_S2D_TL(data_file=new_env_test_data_load_file,
                                              env_info_length=env_info_length,
                                              data_len=None, use_env=False)
    ...
    # load or create model and optimizer (checkpoint)
    Enet = PtNet(dim=2)
    Pnet = GMPN_S2D_CLOUD_MDN_Pnet(input_size=36, output_size=4, mixture_num=mixture_num)
    Enet = Enet.float()
    Pnet = Pnet.float()
    if device == 'cuda':
        Enet.cuda()
...
def Train_Eval_Cloud_input_S2D_ThreeL_MDN_PtNet_Joint_main():
    ...
    train_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Three_Link_vec_Joint_train.npy"
    cloud_file = "../../data/train/s2d/obs_cloud_30000_2_1400_rd.npy"
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/s2d/1000env_400pt/S2D_Three_Link_vec_Joint_test.npy"
    model_name = "MDN_S2D_ThreeL_vec_Joint_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
...
def Train_Eval_Cloud_input_C3D_Point_MDN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    ...
    model_name = "MDN_C3D_Point_Joint_2_debug"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
...
def Train_Eval_Cloud_input_ARM_MDN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    ...
    train_data_load_file = "../../data/train/panda_arm/box_scene_env_0_5_Joint_train.npy"
    cloud_file = "../../data/train/panda_arm/random_box_scence_clouds_500_surface.npy"
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/panda_arm/box_scene_env_0_5_Joint_test.npy"
    model_name = "MDN_ARM_rdbox_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
    ...
    # load or create model and optimizer (checkpoint)
    Enet = PtNet(dim=3)
    Pnet = GMPN_S2D_CLOUD_MDN_Pnet(input_size=42, output_size=7, mixture_num=mixture_num)
    Enet = Enet.float()
    Pnet = Pnet.float()
    if device == 'cuda':
        Enet.cuda()
...
def Train_Eval_Cloud_input_Arm_MDN_main():
    ...
    train_data_load_file = "../../data/train/panda_arm/tb_env0_3800_train.npy"

    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/panda_arm/tb_env0_800_test.npy"
    model_name = "MDN_ARM_TB_BITstar_MIX_50_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
    ...
    # load dataset
    print("Start load dataset!")
    train_dataset = GMPNDataset_Arm(data_file=train_data_load_file, env_info_length=env_info_length, data_len=None)
    # train_env_test_dataset = GMPNDataset(data_file=train_env_test_data_load_file, env_info_length=env_info_length,
    #                                      data_len=None)
    ...
    # load or create model and optimizer (checkpoint)
    model = GMPN_S2D_CLOUD_MDN_Pnet(input_size=42, output_size=7, mixture_num=mixture_num)
    model = model.float()
    if device == 'cuda':
        model.cuda()
    else:
...
def Train_Eval_Cloud_input_C3D_Point_MPN_main():
    # parm set
    device = 'cuda'
    lr = 3 * 1e-4
    weight_decay = 0
...
def Train_Eval_Cloud_input_S2D_RB_MPN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    lr = 3 * 1e-4
    weight_decay = 0
    ...
    # load dataset
    print("Start load dataset!")
    train_dataset = GMPNDataset_S2D_Pt(data_file=train_data_load_file, env_info_length=env_info_length, use_env=False,
                                       data_len=None)
    # train_env_test_dataset = GMPNDataset(data_file=train_env_test_data_load_file, env_info_length=env_info_length,
    #                                      data_len=None)
    new_env_test_dataset = GMPNDataset_S2D_Pt(data_file=new_env_test_data_load_file,
    ...
    Enet = PtNet(dim=2)
    Enet = Enet.float()
    Pnet = S2D_MDN_Pnet(input_size=32, output_size=2)
    Pnet = Pnet.float()
    if device == 'cuda':
        Enet.cuda()
        Pnet.cuda()
...
def Train_Eval_Cloud_input_S2D_RB_MPN_PtNet_Joint_main():
    ...
    # load dataset
    print("Start load dataset!")
    train_dataset = GMPNDataset_S2D_RB(data_file=train_data_load_file, env_info_length=env_info_length, use_env=False,
                                       data_len=None)
    # train_env_test_dataset = GMPNDataset(data_file=train_env_test_data_load_file, env_info_length=env_info_length,
    #                                      data_len=None)
    new_env_test_dataset = GMPNDataset_S2D_RB(data_file=new_env_test_data_load_file,
...
def Train_Eval_Cloud_input_S2D_TwoL_MPN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    lr = 3 * 1e-4
    weight_decay = 0
    ...
    model_name = "MPN_S2D_TwoL_vec_Joint_1_train_mode"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
    ...
    # load dataset
    print("Start load dataset!")
    train_dataset = GMPNDataset_S2D_TL(data_file=train_data_load_file, env_info_length=env_info_length, use_env=False,
                                       data_len=None)
    # train_env_test_dataset = GMPNDataset(data_file=train_env_test_data_load_file, env_info_length=env_info_length,
    #                                      data_len=None)
    new_env_test_dataset = GMPNDataset_S2D_TL(data_file=new_env_test_data_load_file,
...
def Train_Eval_Cloud_input_S2D_ThreeL_MPN_PtNet_Joint_main():
    ...
    model_name = "MPN_S2D_ThreeL_vec_Joint_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
...
def Train_Eval_Cloud_input_C3D_Point_MPN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    lr = 3 * 1e-4
    weight_decay = 0
    ...
    model_name = "MPN_C3D_Point_Joint_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
...
def Train_Eval_Cloud_input_ARM_MPN_PtNet_Joint_main():
    # parm set
    device = 'cuda'
    lr = 3 * 1e-4
    weight_decay = 0
    ...
    # train_env_test_data_load_file = "../../../output/data/S2D/MPN_S2D_train_env_test_82k.npy"
    new_env_test_data_load_file = "../../data/train/panda_arm/box_scene_env_0_5_Joint_test.npy"
    model_name = "MPN_ARM_rdbox_1_0317test"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
...
def Train_Eval_Cloud_input_Arm_MPN_main():
    ...
    model_name = "MPN_ARM_TB_BITstar_1"
    model_dir = "../../data/model/" + model_name + '/'
    load_checkpoint_flag = False
    checkpoint_load_file = '../../../output/model/GMPN_S2D_CLOUD_MDN_6/checkpoint_save/checkpoint_epoch_340.pt'
...
if __name__ == '__main__':
    ...
    # Train_Eval_Cloud_input_C3D_Point_MDN_main()
    # Train_Eval_Cloud_input_C3D_Point_MPN_main()
